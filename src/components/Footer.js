        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                An English vocabulary learning platform for Turkish students.
                Improve your vocabulary with interactive quizzes designed for
                the English curriculum of grades 9–12.
              </p>
            </div>
                ...
                <li className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <div className="text-gray-400">
                      Süleyman Demirel Vocational and Technical Anatolian High School
                    </div>
                  </div>
                </li>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              <p className="text-sm text-gray-400 text-center md:text-left">
                This platform was developed for educational purposes. All rights reserved.
              </p>
              <div className="flex items-center gap-4 text-sm">
                <span className="text-gray-400">Turkey</span>
          ...
          <div className="mt-8 text-center">
            <div className="inline-flex items-center gap-2 text-xs text-gray-500 bg-gray-800 px-4 py-2 rounded-full">
              ...
              <span>GDPR Compliant • Secure Platform</span>
            </div>
          </div>
        </div>
      </footer>
